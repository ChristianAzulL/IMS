...
<div class="row">
    <div class="col-12 mb-3 ms-3 mt-3"><h6>Top 50 Fast Moving Brands (This Week)</h6></div>
</div>
    ...
    <table class="table table-bordered table-striped fs-10 mb-0">
        <thead class="bg-200">
            <tr>
                ...
                <th class="text-900" data-sort="brand_qty">Sold Qty</th>
            </tr>
        </thead>
        <tbody class="list">
<?php
$rank = 1;
foreach ($fast_moving_brands as $brand) {
    echo "<tr>";
    echo "<td>{$rank}</td>";
    echo "<td>{$brand['brand_name']}</td>";
    echo "<td>{$brand['total_sold']}</td>";
    echo "</tr>";
    $rank++;
}
?></tbody>
