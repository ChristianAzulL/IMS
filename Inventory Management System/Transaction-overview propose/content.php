                            ...
                            <table class="table mb-0 fs-10">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th class="fs-10 text-white ">QTY</th>
                                        <th class="fs-10 text-white ">SUBTOTAL UNIT COST</th>
                                        <th class="fs-10 text-white ">SUBTOTAL GROSS SALES</th>
                                        <th class="fs-10 text-white ">SUBTOTAL NET INCOME</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                            ...
                                            if(!empty($imploded_category) && $imploded_category !== "''"){
                                                if(strpos($imploded_category, $category_id)!==false){
                                                    ...
                                                    <tr class="' . $random_bg . '">
                                                        ...
                                                        <td class="fs-10">'. $outbound_qty .'</td>
                                                        <td class="fs-10">' . $sub_unit_cost .'</td>
                                                        <td class="fs-10">' . $sub_gross . '</td>
                                                        <td class="fs-10">' . $sub_netincome . '</td>
                                                    </tr>
                                                    <tr class="' . $random_bg . '">
                                                    ...
                                                    if($item_res->num_rows>0){
                                                        while($row=$item_res->fetch_assoc()){
                                                            ...
                                                            <tr class="' . $random_bg . '">
                                                                ...
                                                                <td class="fs-11">' . $capital . '</td>
                                                                <td class="fs-11">' . $sold_price . '</td>
                                                                <td class="fs-11">' . $net_income . '</td>
                                                            </tr>';
                                                        }
                                                    }
                                                }
